...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v8/nodepool"
...
&nodepool.NodePoolConfig {
	...
	SchedulerConfig: github.com/cdktf/cdktf-provider-nomad-go/nomad/v8.nodePool.NodePoolSchedulerConfig,
}
```
