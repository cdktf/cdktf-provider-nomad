...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/nodepool"
...
&nodepool.NodePoolConfig {
	...
	SchedulerConfig: github.com/cdktf/cdktf-provider-nomad-go/nomad/v10.nodePool.NodePoolSchedulerConfig,
}
```
