...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v4/job"
...
&job.JobConfig {
	...
	Detach: interface{},
	Hcl2: github.com/cdktf/cdktf-provider-nomad-go/nomad/v4.job.JobHcl2,
	Id: *string,
	Json: interface{},
	PolicyOverride: interface{},
	PurgeOnDestroy: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-nomad-go/nomad/v4.job.JobTimeouts,
	VaultToken: *string,
}
```
