...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v7/job"
...
&job.JobConfig {
	...
	Detach: interface{},
	Hcl1: interface{},
	Hcl2: github.com/cdktf/cdktf-provider-nomad-go/nomad/v7.job.JobHcl2,
	Id: *string,
	Json: interface{},
	PolicyOverride: interface{},
	PurgeOnDestroy: interface{},
	ReadAllocationIds: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-nomad-go/nomad/v7.job.JobTimeouts,
	VaultToken: *string,
}
```
