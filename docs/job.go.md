...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v3/job"
...
| <code><a href="#@cdktf/provider-nomad.job.Job.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
...
&job.JobConfig {
	...
	Detach: interface{},
	Hcl2: github.com/cdktf/cdktf-provider-nomad-go/nomad/v3.job.JobHcl2,
	Id: *string,
	Json: interface{},
	PolicyOverride: interface{},
	PurgeOnDestroy: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-nomad-go/nomad/v3.job.JobTimeouts,
	VaultToken: *string,
}
```
...
| <code><a href="#@cdktf/provider-nomad.job.JobConfig.property.count">Count</a></code> | <code>*f64</code> | *No description.* |
