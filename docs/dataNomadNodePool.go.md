...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/datanomadnodepool"
...
| <code><a href="#@cdktf/provider-nomad.dataNomadNodePool.DataNomadNodePoolConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.0/docs/data-sources/node_pool#id DataNomadNodePool#id}. |
