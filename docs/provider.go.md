...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/provider"
...
```go
func AuthJwtInput() NomadProviderAuthJwt
```
...
```go
func AuthJwt() NomadProviderAuthJwt
```
...
&provider.NomadProviderConfig {
	Address: *string,
	Alias: *string,
	AuthJwt: github.com/cdktf/cdktf-provider-nomad-go/nomad/v10.provider.NomadProviderAuthJwt,
	CaFile: *string,
	CaPem: *string,
	CertFile: *string,
	CertPem: *string,
