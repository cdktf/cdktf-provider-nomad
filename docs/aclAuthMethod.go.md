...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v4/aclauthmethod"
...
&aclauthmethod.AclAuthMethodConfig {
	...
	Config: github.com/cdktf/cdktf-provider-nomad-go/nomad/v4.aclAuthMethod.AclAuthMethodConfigA,
	MaxTokenTtl: *string,
	Name: *string,
