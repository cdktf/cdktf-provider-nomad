...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v8/datanomadplugins"
...
| <code><a href="#@cdktf/provider-nomad.dataNomadPlugins.DataNomadPluginsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.0.0/docs/data-sources/plugins#id DataNomadPlugins#id}. |
