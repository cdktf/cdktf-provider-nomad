...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v5/namespace"
...
&namespace.NamespaceConfig {
	...
	Name: *string,
	Capabilities: github.com/cdktf/cdktf-provider-nomad-go/nomad/v5.namespace.NamespaceCapabilities,
	Description: *string,
	Id: *string,
