...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v7/namespace"
...
&namespace.NamespaceConfig {
	...
	Name: *string,
	Capabilities: github.com/cdktf/cdktf-provider-nomad-go/nomad/v7.namespace.NamespaceCapabilities,
	Description: *string,
	Id: *string,
	Meta: *map[string]*string,
	NodePoolConfig: github.com/cdktf/cdktf-provider-nomad-go/nomad/v7.namespace.NamespaceNodePoolConfig,
	Quota: *string,
}
```
