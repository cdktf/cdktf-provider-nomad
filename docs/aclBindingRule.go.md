...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/aclbindingrule"
...
| <code><a href="#@cdktf/provider-nomad.aclBindingRule.AclBindingRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.0/docs/resources/acl_binding_rule#id AclBindingRule#id}. |
