...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/schedulerconfig"
...
| <code><a href="#@cdktf/provider-nomad.schedulerConfig.SchedulerConfigConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/scheduler_config#id SchedulerConfig#id}. |
