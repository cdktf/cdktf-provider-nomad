...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v10/aclpolicy"
...
&aclpolicy.AclPolicyConfig {
	...
	Description: *string,
	Id: *string,
	JobAcl: github.com/cdktf/cdktf-provider-nomad-go/nomad/v10.aclPolicy.AclPolicyJobAcl,
}
```
