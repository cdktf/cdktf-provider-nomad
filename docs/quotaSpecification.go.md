...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v3/quotaspecification"
...
&quotaspecification.QuotaSpecificationLimits {
	Region: *string,
	RegionLimit: github.com/cdktf/cdktf-provider-nomad-go/nomad/v3.quotaSpecification.QuotaSpecificationLimitsRegionLimit,
}
```
