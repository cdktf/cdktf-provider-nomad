...
```go
import "github.com/cdktf/cdktf-provider-nomad-go/nomad/v6/quotaspecification"
...
&quotaspecification.QuotaSpecificationLimits {
	Region: *string,
	RegionLimit: github.com/cdktf/cdktf-provider-nomad-go/nomad/v6.quotaSpecification.QuotaSpecificationLimitsRegionLimit,
}
```
