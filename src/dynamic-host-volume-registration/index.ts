...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.2/docs/resources/dynamic_host_volume_registration
...
export class DynamicHostVolumeRegistration extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamicHostVolumeRegistration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.2/docs/resources/dynamic_host_volume_registration#import import section} in the documentation of this resource for the id to use
