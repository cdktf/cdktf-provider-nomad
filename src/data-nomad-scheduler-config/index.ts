...
// https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/data-sources/scheduler_config
...
export class DataNomadSchedulerConfig extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadSchedulerConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/data-sources/scheduler_config#import import section} in the documentation of this resource for the id to use
