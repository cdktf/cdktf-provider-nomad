...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/csi_volume
...
export class CsiVolume extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing CsiVolume that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/csi_volume#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/csi_volume nomad_csi_volume} Resource
  *
  * @param scope The scope in which to define this construct
