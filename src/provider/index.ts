...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.2/docs
...
export class NomadProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing NomadProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.2/docs#import import section} in the documentation of this resource for the id to use
