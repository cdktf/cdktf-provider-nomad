...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/datacenters
...
export class DataNomadDatacenters extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadDatacenters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/datacenters#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/datacenters nomad_datacenters} Data Source
  *
  * @param scope The scope in which to define this construct
