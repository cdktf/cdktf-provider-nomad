// https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/node_pools
...
export class DataNomadNodePools extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadNodePools that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/node_pools#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/node_pools nomad_node_pools} Data Source
  *
  * @param scope The scope in which to define this construct
