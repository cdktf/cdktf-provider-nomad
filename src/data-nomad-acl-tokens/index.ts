...
// https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/data-sources/acl_tokens
...
export class DataNomadAclTokens extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadAclTokens that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/data-sources/acl_tokens#import import section} in the documentation of this resource for the id to use
