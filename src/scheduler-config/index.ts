...
// https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/scheduler_config
...
export class SchedulerConfig extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SchedulerConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/scheduler_config#import import section} in the documentation of this resource for the id to use
