...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/scaling_policies
...
export class DataNomadScalingPolicies extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadScalingPolicies that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/scaling_policies#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/data-sources/scaling_policies nomad_scaling_policies} Data Source
  *
  * @param scope The scope in which to define this construct
