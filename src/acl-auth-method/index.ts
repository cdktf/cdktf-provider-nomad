...
// https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/acl_auth_method
...
export class AclAuthMethod extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AclAuthMethod that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/acl_auth_method#import import section} in the documentation of this resource for the id to use
