// https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/acl_policy
...
export class AclPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AclPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/acl_policy#import import section} in the documentation of this resource for the id to use
