...
// https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/quota_specification
...
export class QuotaSpecification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaSpecification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.1/docs/resources/quota_specification#import import section} in the documentation of this resource for the id to use
