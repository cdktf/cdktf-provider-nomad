...
// https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/quota_specification
...
export class QuotaSpecification extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing QuotaSpecification that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/quota_specification#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.5.1/docs/resources/quota_specification nomad_quota_specification} Resource
  *
  * @param scope The scope in which to define this construct
