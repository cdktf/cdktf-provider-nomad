// https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/variable
...
export class Variable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing Variable that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.3.0/docs/resources/variable#import import section} in the documentation of this resource for the id to use
