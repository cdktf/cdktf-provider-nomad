// https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/scaling_policy
...
export class DataNomadScalingPolicy extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadScalingPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/scaling_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/scaling_policy nomad_scaling_policy} Data Source
  *
  * @param scope The scope in which to define this construct
