...
// https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/regions
...
export class DataNomadRegions extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNomadRegions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/regions#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/nomad/2.4.0/docs/data-sources/regions nomad_regions} Data Source
  *
  * @param scope The scope in which to define this construct
